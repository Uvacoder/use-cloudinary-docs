...
title: useSearch
---
Combining our `useSearch` hook with a serverless endpoint will let you create different ways to call multiple  or individual assets, based off of tags or types. 
...
Our `search` function simply can accept any of the options you would expect to send to the [Search API](https://cloudinary.com/documentation/search_api).
