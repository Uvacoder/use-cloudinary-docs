...
Next, another important chunk of information to get acquainted with is Cloudinary's [Image](https://cloudinary.com/documentation/image_transformation_reference) and [Video](https://cloudinary.com/documentation/video_transformation_reference) transformation options. These options can be utilized through all of the hooks to decide what your media should look like when we request it. 
